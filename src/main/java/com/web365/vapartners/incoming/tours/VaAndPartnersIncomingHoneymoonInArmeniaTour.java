...
import static com.web365.vapartners.incoming.tours.VaAndPartnersIncomingHoneymoonInArmeniaTourConstants. *;
public class VaAndPartnersIncomingHoneymoonInArmeniaTour extends VaAndPartnersBasePage {

	public VaAndPartnersIncomingHoneymoonInArmeniaTour(WebDriver driver) {
		super(driver);
		this.driver = driver;
	}
	...
	@FindBy(xpath = HONEYMOON_IN_ARMENIA_ORDR_FORM_XPATH)
