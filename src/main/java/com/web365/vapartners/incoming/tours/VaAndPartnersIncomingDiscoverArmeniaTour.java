...
import static com.web365.vapartners.incoming.tours.VaAndPartnersIncomingDiscoverArmeniaTourConstants. *;
public class VaAndPartnersIncomingDiscoverArmeniaTour extends VaAndPartnersBasePage {

	public VaAndPartnersIncomingDiscoverArmeniaTour(WebDriver driver) {
		super(driver);
		this.driver = driver;
	}
	...
	@FindBy(xpath = DISCOVER_ARMENIA_MORE_BUTTON_XPATH)
	public WebElement more;
	
	@FindBy(xpath = DISCOVER_ARMENIA_ORDR_FORM_XPATH)
