...
public class VaAndPartnersIncomingUniqueArmeniaWithSafariTourConstants {

	
	public static final String INCOMING_TOUR_XPATH = "//a[@href='/Packages/Tours?id=90\']";
	public static final String UNIQUE_ARMENIA_WITH_SAFARI_MORE_BUTTON_XPATH = "//a[@href='/Packages/Tour?id=488']";
	public static final String ARMENIA_WITH_SAFARI_ORDR_FORM_XPATH = "//div[@class='tour_cont_form ']";
