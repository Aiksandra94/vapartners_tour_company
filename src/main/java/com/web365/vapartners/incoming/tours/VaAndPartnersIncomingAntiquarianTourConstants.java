...
public class VaAndPartnersIncomingAntiquarianTourConstants {

	
	public static final String INCOMING_TOUR_XPATH = "//a[@href='/Packages/Tours?id=90\']";
	public static final String ANTIQUARIAN_TOUR_MORE_XPATH = "//a[@href='/Packages/Tour?id=489']";
	public static final String ANTIQUARIAN_TOUR_ORDR_FORM_XPATH = "//div[@class='tour_cont_form ']";
