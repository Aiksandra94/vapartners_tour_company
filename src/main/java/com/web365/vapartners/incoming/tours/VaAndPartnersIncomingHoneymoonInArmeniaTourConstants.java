...
public class VaAndPartnersIncomingHoneymoonInArmeniaTourConstants {

	public static final String INCOMING_TOUR_XPATH = "//a[@href='/Packages/Tours?id=90\']";
	public static final String HONEYMOON_IN_ARMENIA_MORE_BUTTON_XPATH = "//a[@href='/Packages/Tour?id=491']";
	public static final String HONEYMOON_IN_ARMENIA_ORDR_FORM_XPATH = "//div[@class='tour_cont_form ']";
