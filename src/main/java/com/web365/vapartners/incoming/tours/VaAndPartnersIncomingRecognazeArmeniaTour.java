...
import static com.web365.vapartners.incoming.tours.VaAndPartnersIncomingRecognazeArmeniaTourConstants. *;

public class VaAndPartnersIncomingRecognazeArmeniaTour extends VaAndPartnersBasePage{

	public VaAndPartnersIncomingRecognazeArmeniaTour(WebDriver driver) {
		super(driver);
		this.driver = driver;
	}
	...
	@FindBy(xpath = RECOGNIZE_ARMENIA_ORDR_FORM_XPATH)
