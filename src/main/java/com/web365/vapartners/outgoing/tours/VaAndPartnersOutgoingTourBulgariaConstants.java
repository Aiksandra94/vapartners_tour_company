...
public class VaAndPartnersOutgoingTourBulgariaConstants {
	
	    public static final String OUTGOING_TOURS_XPATH = "//a[@href='/Packages/Tours?id=87']";
	    public static final String BULGARIA_MORE_BUTTON = "//a[@href='/Packages/Tour?id=460']";
	    public static final String BULGARIA_TOUR_FORM = "//div[@class='tour_cont_form ']";
