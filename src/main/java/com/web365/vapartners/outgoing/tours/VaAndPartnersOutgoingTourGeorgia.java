...
public class VaAndPartnersOutgoingTourGeorgia extends VaAndPartnersBasePage {

	public VaAndPartnersOutgoingTourGeorgia(WebDriver driver) {
		super(driver);
		this.driver = driver;
	}

	    public static final String OUTGOING_TOURS_XPATH = "//a[@href='/Packages/Tours?id=87']";
	    public static final String MORE_BUTTON = "//a[@href='/Packages/Tour?id=459']";
	    public static final String GEORGIA_TOUR = "//div[@class='tour_cont_form ']";
		...
		public VaAndPartnersOutgoingTourGeorgia goToMore() {
			outgoingTours.click();
