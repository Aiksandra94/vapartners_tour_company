...
public class VaAndPartnersOutgoingTourNorwayConstants {

	public static final String NORWAY_OUTGOING_TOURS_XPATH = "//a[@href='/Packages/Tours?id=87']";
	public static final String NORWAY_MORE_BUTTON = "//a[@href='/Packages/Tour?id=465']";
	public static final String NORWAY_TOUR_FORM = "//div[@class='tour_cont_form ']";
