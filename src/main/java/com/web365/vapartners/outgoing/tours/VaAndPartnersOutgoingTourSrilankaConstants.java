...
public class VaAndPartnersOutgoingTourSrilankaConstants {
	
	public static final String OUTGOING_TOURS_XPATH = "//a[@href='/Packages/Tours?id=87']";
	public static final String MORE_BUTTON = "//a[@href='/Packages/Tour?id=457\']";
	public static final String SRILANKA_TOUR = "//div[@class='tour_cont_form']";
