...
public class VaAndPartnersOutgoingTourCyprusConstants {

	
	public static final String CYPRUS_OUTGOING_TOURS_XPATH = "//a[@href='/Packages/Tours?id=87']";
	public static final String CYPRUS_MORE_BUTTON = "//a[@href='/Packages/Tour?id=463']";
	public static final String CYPRUS_TOUR_FORM = "//div[@class='tour_cont_form ']";
