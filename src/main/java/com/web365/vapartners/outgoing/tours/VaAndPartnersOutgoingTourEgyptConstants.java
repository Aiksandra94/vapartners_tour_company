...
public class VaAndPartnersOutgoingTourEgyptConstants {

	public static final String EGYPT_OUTGOING_TOURS_XPATH = "//a[@href='/Packages/Tours?id=87']";
	public static final String EGYPT_MORE_BUTTON = "//a[@href='/Packages/Tour?id=468']";
	public static final String EGYPT_TOUR_FORM = " //div[@class='tour_cont_form ']";
