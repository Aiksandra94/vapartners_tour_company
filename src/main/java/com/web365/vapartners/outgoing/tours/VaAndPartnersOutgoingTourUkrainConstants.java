...
public class VaAndPartnersOutgoingTourUkrainConstants {

	
	public static final String UKRAIN_OUTGOING_TOURS_XPATH = "//a[@href='/Packages/Tours?id=87']";
	public static final String UKRAIN_MORE_BUTTON = "//a[@href='/Packages/Tour?id=473']";
	public static final String UKRAIN_TOUR_FORM = " //div[@class='tour_cont_form ']";
